...
describe('Test para la clase Collection', () => {
  ...
  // (private nombre:string, private cantantes:string[], private duracion:number,
  ...
  // it('addAlbum => to not throw', () => {
  //   expect(colleccion.addAlbum('Dua Lipa', 2021, 'Hotter than Hell', 'Dua Lipa')).to.not.throw;
  // });
