...
export class GenerosMusicales {
     ...
     * @param generoCanciones Canciones que hay dentro de la biblioteca de ese género
     */
    constructor(private genero: string, private grupos_artistas: string[], private generoAlbumes: Album[], private generoCanciones: Cancion[] ) {}
